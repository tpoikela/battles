...
Cell.prototype.setX = function(x: number) {this._x = x;};
Cell.prototype.setY = function(y: number) {this._y = y;};
...
Cell.prototype.hasElements = function(): bool {
    return this.hasProp(TYPE_ELEM);
};
Cell.prototype.getElements = function(): Element[] {
    return this.getProp(TYPE_ELEM);
};

/* Returns true if cell has any actors.*/
Cell.prototype.hasActors = function(): bool {
    return this.hasProp(TYPE_ACTOR);
};
Cell.prototype.getActors = function(): bool {
    return this.getProp(TYPE_ACTOR);
};
Cell.prototype.getFirstActor = function(): Actor {
...
Cell.prototype.hasMarker = function(tag) {
    if (this.hasElements()) {
        const elems: Element[] = this.getElements();
...
Cell.prototype.hasShop = function(): bool {
...
Cell.prototype.hasConnectionType = function(type: string) {

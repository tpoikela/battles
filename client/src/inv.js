...
RG.Inv.Inventory.prototype.addItem = function(item) {
    this._inv.addItem(item);
};
RG.Inv.Inventory.prototype.hasItem = function(item) {
    return this._inv.hasItem(item);
};
RG.Inv.Inventory.prototype.removeItem = function(item) {
    return this._inv.removeItem(item);
};

RG.Inv.Inventory.prototype.removeNItems = function(item, n) {
    return this._inv.removeNItems(item, n);
};

RG.Inv.Inventory.prototype.getRemovedItem = function() {
    return this._inv.getRemovedItem();
};

/* For using item inside the container. */
RG.Inv.Inventory.prototype.useItem = function(item, obj) {
...
RG.Inv.Inventory.prototype.canCarryItem = function(item) {
...
RG.Inv.Inventory.prototype.dropItem = function(item) {
...
RG.Inv.Inventory.prototype.dropNItems = function(item, n) {
...
RG.Inv.Inventory.prototype.removeAndGetItem = function(item) {
    if (this._inv.removeItem(item)) {
...
RG.Inv.Inventory.prototype.getInventory = function() {
    return this._inv;
};

RG.Inv.Inventory.prototype.getEquipment = function() {
    return this._eq;
};

/* Removes item from inventory and equips it.*/
RG.Inv.Inventory.prototype.equipItem = function(item) {
    if (this._inv.hasItem(item)) {
...
RG.Inv.Inventory.prototype._getItemToEquip = function(item) {
...
RG.Inv.Inventory.prototype.equipNItems = function(item, n) {
    if (this._inv.hasItem(item)) {
...
RG.Inv.Inventory.prototype.unequipItem = function(slotType, n, slotNumber) {
...
RG.Inv.Inventory.prototype.unequipAndGetItem = function(
...
RG.Inv.Inventory.prototype.getWeapon = function() {
    const item = this._eq.getItem('hand');
    if (!RG.isNullOrUndef([item])) {return item;}
    return null;
};

RG.Inv.Inventory.prototype.getMissileWeapon = function() {
    const item = this._eq.getItem('missileweapon');
    if (!RG.isNullOrUndef([item])) {return item;}
    return null;
};

RG.Inv.Inventory.prototype.getMissile = function() {
    const item = this._eq.getItem('missile');
    return item;
};

RG.Inv.Inventory.prototype.getEquipped = function(slotType) {

...
* tunnel through any obstacles eventually. */
Path.getMinWeightPath = function(map, x0, y0, x1, y1) {
    const coordPassable = Path.getShortestPassablePath(map,
        x0, y0, x1, y1);

...
//----------------------
RG.EVT_ACTOR_CREATED = Symbol('EVT_ACTOR_CREATED');
RG.EVT_ACTOR_KILLED = Symbol('EVT_ACTOR_KILLED');
RG.EVT_DESTROY_ITEM = Symbol('EVT_DESTROY_ITEM');
RG.EVT_MSG = Symbol('EVT_MSG');

RG.EVT_LEVEL_CHANGED = Symbol('EVT_LEVEL_CHANGED');
RG.EVT_LEVEL_ENTERED = Symbol('EVT_LEVEL_ENTERED');
RG.EVT_TILE_CHANGED = Symbol('EVT_TILE_CHANGED');
RG.EVT_EXPLORED_ZONE_LEFT = Symbol('EVT_EXPLORED_ZONE_LEFT');

RG.EVT_LEVEL_PROP_ADDED = Symbol('EVT_LEVEL_PROP_ADDED');
RG.EVT_LEVEL_PROP_REMOVED = Symbol('EVT_LEVEL_PROP_REMOVED');

RG.EVT_ACT_COMP_ADDED = Symbol('EVT_ACT_COMP_ADDED');
RG.EVT_ACT_COMP_REMOVED = Symbol('EVT_ACT_COMP_REMOVED');
RG.EVT_ACT_COMP_ENABLED = Symbol('EVT_ACT_COMP_ENABLED');
RG.EVT_ACT_COMP_DISABLED = Symbol('EVT_ACT_COMP_DISABLED');

RG.EVT_WIN_COND_TRUE = Symbol('EVT_WIN_COND_TRUE');

RG.EVT_ANIMATION = Symbol('EVT_ANIMATION');

RG.EVT_CREATE_BATTLE = Symbol('EVT_CREATE_BATTLE');
RG.EVT_BATTLE_OVER = Symbol('EVT_BATTLE_OVER');
RG.EVT_ARMY_EVENT = Symbol('EVT_ARMY_EVENT');

// Mostly used at low-level by System.Event
RG.EVT_ITEM_PICKED_UP = Symbol('EVT_ITEM_PICKED_UP');
RG.EVT_ACTOR_DAMAGED = Symbol('EVT_ACTOR_DAMAGED');
RG.EVT_ACTOR_ATTACKED = Symbol('EVT_ACTOR_ATTACKED');
RG.EVT_ACTOR_USED_STAIRS = Symbol('EVT_ACTOR_USED_STAIRS');

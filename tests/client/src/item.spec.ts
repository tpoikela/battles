...
describe('How items are typed, physical entities', () => {
    ...
    it('has a type', () => {
        Object.keys(Item).forEach(item => {
            if (!(/Container/).test(item)) {
                ...
                expect(newItem.getType(), 'Item.' + item).not.to.be.empty;
            }
        });
    });
    ...
    it('can be compared', () => {
        ...
        const arrow1 = new Item.Missile('Arrow');
        const arrow2 = new Item.Missile('Steel arrow');
...
describe('How items are stacked', () => {
    ...
    it('Stacks weapons correctly', () => {
        const weapon1 = new Item.Weapon('Short sword');
        weapon1.setAttack(3);
        const weapon2 = new Item.Weapon('Short sword');
        weapon2.setAttack(3);
...
describe('How inventory container works', () => {
    ...
    it('Checks items by reference for existence', () => {
        ...
        const invEq = new Inventory(player);
        ...
        const steelArrow4 = new Item.Missile('Steel arrow');
        const steelArrow1 = new Item.Missile('Steel arrow');
        ...
        const rubyArrow1 = new Item.Missile('Ruby arrow');
        const rubyArrow6 = new Item.Missile('Ruby arrow');
        ...
        const ebonyArrow3 = new Item.Missile('Ebony arrow');
        const ebonyArrow5 = new Item.Missile('Ebony arrow');
...
describe('How item stacks work with equipped missiles', () => {
    ...
    it('Stacks item in inv when added individually', () => {
        ...
        const testArrow = new Item.Missile('Steel arrow');
        ...
        const sixArrows = new Item.Missile('Steel arrow');
        ...
        const anotherSix = new Item.Missile('Steel arrow');
    ...
    it('Equips armour correctly', () => {
        const collar = new Item.Armour('Collar');
        collar.setArmourType('neck');
        inv.addItem(collar);
        expect(invEq.equipItem(collar)).to.equal(true);

        const plate = new Item.Armour('Plate mail');
...
describe('Gold coins and other valuables', () => {
    it('Has weight and stacks normally', () => {
        ...
        const coin = new Item.GoldCoin();
        expect(coin.getPurity()).to.equal(1.0);

    });
});

describe('Item.MissileWeapon', () => {
